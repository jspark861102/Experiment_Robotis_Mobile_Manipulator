...
uint8_t left_rear_wheel_id_   = DXL_LEFT_REAR_ID; 
uint8_t right_rear_wheel_id_  = DXL_RIGHT_REAR_ID;
uint8_t left_front_wheel_id_  = DXL_LEFT_FRONT_ID; 
uint8_t right_front_wheel_id_ = DXL_RIGHT_FRONT_ID;
...
double goal_time_joint_gripper[4] = {0.0, 0.0, 0.0, 0.0};
bool RCinput = false;
