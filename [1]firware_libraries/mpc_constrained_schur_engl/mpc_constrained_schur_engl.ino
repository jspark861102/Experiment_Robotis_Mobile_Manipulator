...
void setup() {
   ...
   B[0][0] = -0.00447214; B[0][1] =  0.00894427; B[0][2] = 0;
   B[1][0] = -0.00894427; B[1][1] = -0.00447214; B[1][2] = 0;
   B[2][0] =  0;          B[2][1] =  0;          B[2][2] = 0.01;    
   */
   ...
   ineqLHS[0][0] = 1.0; ineqLHS[0][1] = 0.0;
   ineqLHS[1][0] = 0.0; ineqLHS[1][1] = 1.0;
   ineqLHS[2][0] =-1.0; ineqLHS[2][1] = 0.0;
   ineqLHS[3][0] = 0.0; ineqLHS[3][1] =-1.0;
   ineqLHS[4][0] = 1.0; ineqLHS[4][1] = 1.0;
   ineqLHS[5][0] =-1.0; ineqLHS[5][1] =-1.0;
...
void loop() {
    if (timerMPC > SS_DT_MILIS) {  
        ...
        */
        ...
        MPC_HIL.bActiveSet(x, Q, Q_inv, c, ineqLHS, ineqRHS, i16iterSP);        
        ...
        /* =========================== Print to serial (for plotting) ========================== */
            ...
            //snprintf(bufferTxSer, 6, "%.3f", 0.35158);
        #else
        ...
        #endif        
        //Serial.print(((float)_maxu64compuTime)/1000.); Serial.print("   "); 
        //Serial.print(MPC_HIL.cntIterActiveSet);        Serial.print("   ");  
        //Serial.print(SP[0][0]);                        Serial.print("   ");  
        //Serial.print(SP[1][0]);                        Serial.print("   ");  
        //Serial.print(z[0][0]);                         Serial.print("   ");  
        //Serial.println(z[1][0]);        

        Serial.print(x[0][0]);                         Serial.print("   ");  
        Serial.println(x[1][0]);    
        Serial.println(i16iterSP);        
        /* --------------------------- Print to serial (for plotting) -------------------------- */       
        timerMPC = 0;        
    }
}
